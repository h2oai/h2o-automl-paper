...
source(here("data", dataset_name, "load_train_test.R"))
...
# Baseline AutoML
cat("Starting H2O AutoML...\n")
project_name <- paste(dataset_name, train_size, max_runtime_secs, experiment_name, sep = "_")
